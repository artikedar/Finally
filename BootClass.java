...
//			System.out.println(film);
		...
		case 3:
			...
			switch(opt1) {
			case 1:
				Map<Integer, Film> filmList31=filmService.getAllFilms();
				Collection<Film> filrem=filmList31.values();  
				userInter.removeFilm(filrem);
				break;
				
			case 2:
				Map<Integer, Film> filmList32=filmService.getAllFilms();
				Collection<Film> filrem1=filmList32.values();  
				userInter.removeFilmByRating(filrem1);
				break;
				
			case 3:
				Map<Integer, Film> filmList33=filmService.getAllFilms();
